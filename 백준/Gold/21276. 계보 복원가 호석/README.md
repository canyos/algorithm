...
### 해설
모든 조상을 기억하고 있으므로 자신의 depth는 기억하는 조상의 수이다.

부모와 자식의 depth는 1차이 이므로 edge를 돌며 자식인지 조사한다.

부모-자식 이라면 서로의 정보를 추가한다.

모든 조상을 기억하므로 depth로 사용하는 것이 중요
